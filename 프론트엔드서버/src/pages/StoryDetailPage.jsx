...
const StoryDetailPage = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://developark.duckdns.org/api_wonderland/stories/${id}`)
      .then((res) => {
  ...
  const fallback = "https://developark.duckdns.org/webdav/bucket/imageholder/place.jpg";
    ...
    >
      {pageIndex === 0 ? (
        ...
        >
          ...
          >
            <img
              src={currentPage.image_url || fallback}
              alt={`page-${pageIndex}`}
              className="img-fluid rounded"
              style={{ maxHeight: '100%', objectFit: 'contain' }}
            />
