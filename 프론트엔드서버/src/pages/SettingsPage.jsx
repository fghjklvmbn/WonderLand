...
const SettingsPage = () => {
  ...
  useEffect(() => {
    axios
      .get('https://developark.duckdns.org/api_wonderland/mypage/myinfo', { withCredentials: true })
      .then((res) => {
  ...
  const handleNicknameUpdate = async () => {
    try {
      await axios.put(
        'https://developark.duckdns.org/api_wonderland/users/me/nickname',
        { nickname },
  ...
  const handlePasswordChange = async () => {
    try {
      await axios.put(
        'https://developark.duckdns.org/api_wonderland/users/me/password',
        passwords,
        { withCredentials: true }
      );
