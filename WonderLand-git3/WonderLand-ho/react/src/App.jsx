...
import StoryCreate from './pages/StoryCreate'; // 이야기 생성MyCreatedStories

//용태 추가 코드
import CreateVoiceModel from './pages/CreateRecodeModel'; // 파일 경로에 맞게 수정
        ...
        <div className="d-flex flex-column min-vh-100">
          ...
          <main className="flex-grow-1">
            <Routes>
              ...
              <Route path="/createRecodeModel" element={<CreateVoiceModel />} />
              {/* 우빈 추가 코드 */}
            </Routes>
          </main>
